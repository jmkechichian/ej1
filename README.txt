...
a persistence unit "ej1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ej1/pom.xml":
...
artifacts ("ej1-ejb.jar" and "ej1-web.war") are already built. You can build
